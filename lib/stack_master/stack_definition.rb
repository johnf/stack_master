module StackMaster
  class StackDefinition
    ...
    def parameter_files
      [ default_parameter_file_path, environment_parameter_file_path, region_parameter_file_path, common_parameter_file_path ].flatten.compact
    end
    ...
    def common_parameter_file_path
      ...
      paths << File.join(base_dir, 'parameters', "#{environment}.yml")
